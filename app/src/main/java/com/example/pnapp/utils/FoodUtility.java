...
public class FoodUtility {
	 ...
	 */
	public static Food parseFoodFromJSONObject(JSONObject json) throws JSONException {
	 ...
	 */
	public static CompactFood parseCompactFoodFromJSONObject(JSONObject json) throws JSONException {
	 ...
	 */
	public static List<CompactFood> parseCompactFoodListFromJSONArray(JSONArray array) throws JSONException {
