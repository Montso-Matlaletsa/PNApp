 ...
 */
package com.example.pnapp.utils;
...
public class RecipeUtility {
	 ...
	 */
	public static Recipe parseRecipeFromJSONObject(JSONObject json) throws JSONException {
	 ...
	 */
	public static CompactRecipe parseCompactRecipeFromJSONObject(JSONObject json) throws JSONException {
	 ...
	 */
	public static List<CompactRecipe> parseCompactRecipeListFromJSONArray(JSONArray array) throws JSONException {
	 ...
	 */
	public static Category parseJsonToCategory(JSONObject json) throws JSONException {
	 ...
	 */
	public static Direction parseJsonToDirection(JSONObject json) throws JSONException {
	 ...
	 */
	public static Ingredient parseJsonToIngredient(JSONObject json) throws JSONException {
